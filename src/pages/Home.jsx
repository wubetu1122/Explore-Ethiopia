...
const HeroSection = () => {
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300"> {/* Smooth transition between light and dark */}
            {/* Wrapper for content */}
            <div className="flex flex-col md:flex-row h-auto md:h-screen mx-auto max-w-7xl p-4 md:p-8">
                {/* Left Section */}
                <div className="md:w-3/5 w-full flex flex-col justify-start md:justify-center md:pt-0 pt-4">
                    ...
                    <div className="flex-grow flex flex-col justify-between mt-4 md:mt-0" style={{ minHeight: '400px' }}>
                        <div>
                            ...
                            <p className="text-base md:text-lg text-pencil-500 dark:text-gray-300 font-railway mb-8 md:mb-12">
                ...
                <div className="md:w-2/5 w-full flex justify-center items-start bg-white dark:bg-gray-900 mt-8 md:mt-0">
                                ...
                                <div className="flex-shrink-0 grid grid-cols-1 gap-y-4">
                                    ...
                                    <div className="mt-8 sm:mt-16 flex justify-center">
                                        <Link to="/about"> {/* Use Link to navigate to the about page */}
                                            <button className="bg-redish-500 dark:bg-yellow-500 text-white dark:text-gray-100 text-lg font-lora font-bold py-2 px-4 rounded-lg hover:bg-redish-700 dark:hover:bg-red-600 transition duration-300">
                                                Learn More
                                            </button>
                                        </Link>
                                    </div>
